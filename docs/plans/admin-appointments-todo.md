...
- Chưa implement.
- Chỉ bắt đầu `AA-01` sau khi người dùng duyệt `docs/specs/SPEC-admin-appointments.md` và `docs/plans/admin-appointments-plan.md`.

## Phase 1 — Domain foundation

- [ ] `AA-01` Viết appointment domain tests
...
- [ ] `AA-02` Implement contracts, fixtures và pure state helpers
  - Depends on: `AA-01`.
...
- [ ] Focused tests xanh và bao phủ boundary time liền kề/overlap.
- [ ] Không dùng React, browser API hoặc dữ liệu page module khác trong pure helpers.

## Phase 2 — Route and daily schedule

- [ ] `AA-03` Tạo route shell và bật navigation
  - Depends on: `AA-02`.
...
- [ ] `AA-04` Dựng toolbar, status filter và daily list/summary
  - Depends on: `AA-03`.
...
- [ ] Route/menu/date/filter/list/summary hoạt động không reload.
- [ ] Empty state không hiển thị detail cũ.
- [ ] Tests và TypeScript pass.

## Phase 3 — Calendar and detail

- [ ] `AA-05` Dựng day/week/month calendar views
  - Depends on: `AA-04`.
...
- [ ] `AA-06` Dựng detail panel và message action
...
- [ ] Hierarchy ba vùng bám ảnh tham chiếu tại 1440px.
- [ ] Ngày/Tuần/Tháng và detail dùng cùng selected state.
- [ ] 320/768/1024/1440px không có page-level overflow.

## Phase 4 — Local management

- [ ] `AA-07` Dựng create/edit appointment Modal
...
- [ ] `AA-08` Dựng cancel confirmation flow
  - Depends on: `AA-07`.
...
- [ ] Create/edit/cancel và validation đạt trên fixture.
- [ ] Reload khôi phục fixture gốc đúng boundary đã duyệt.
- [ ] Modal/AlertDialog keyboard và focus management đạt.

## Phase 5 — Integration and verification

- [ ] `AA-09` Nối dashboard entry points và polish responsive
  - Depends on: `AA-06`.
...
- [ ] `AA-10` Chạy full verification và review
...
- [ ] Docs có verification record với số test, routes và viewport thực tế.
