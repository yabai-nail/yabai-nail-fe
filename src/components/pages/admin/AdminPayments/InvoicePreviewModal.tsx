...
export function InvoicePreviewModal({ invoice, branchId, totals, onClose }: Readonly<{ invoice: CheckoutInvoice; branchId: string; totals: PaymentTotals; onClose: () => void }>) {
