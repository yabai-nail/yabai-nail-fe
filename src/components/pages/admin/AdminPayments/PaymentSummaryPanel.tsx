...
export function PaymentSummaryPanel({ invoice, totals, canAdjust, canConfirmPayment, canCreateReview, onSaveAdjustments, onConfirm, onPreview, onReview }: Readonly<{
