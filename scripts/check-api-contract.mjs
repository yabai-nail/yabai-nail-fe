...
function contracts(ids) {
  ...
  return [
    ...
    ["GET /admin/branches", "/admin/branches", ["items.[].id", "items.[].name", "items.[].address", "items.[].active", "pageInfo.endCursor", "pageInfo.hasNextPage", "pageInfo.limit"]],
    ...
    ["GET /admin/accounts", "/admin/accounts", ["items.[].id", "items.[].displayName", "items.[].role", "items.[].accountStatus", "pageInfo.endCursor", "pageInfo.hasNextPage", "pageInfo.limit"]],
    ...
    ["GET /admin/audit-logs", "/admin/audit-logs", ["items.[].action", "items.[].actorId", "items.[].resourceType", "items.[].resourceId", "pageInfo.endCursor", "pageInfo.hasNextPage", "pageInfo.limit"]],
    ...
    ["GET /admin/branches/{b}/shifts", `/admin/branches/${branchId}/shifts`, ["items.[].id", "items.[].staffId", "items.[].localDate", "items.[].startLocalTime", "items.[].endLocalTime", "items.[].approvalStatus", "pageInfo.endCursor", "pageInfo.hasNextPage", "pageInfo.limit"]],
